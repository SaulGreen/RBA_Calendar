class LogController < ApplicationController
	...
	def GetFullLog
		...
		@action = Appointment.joins("INNER JOIN clients c on c.id = appointments.client_id").where("fecha > ? AND case_type_id = 4","2016-12-18").select("nombreclt, apaternoclt, amaternoclt, fecha, hora, comentario").order("fecha ASC").all
